...
public class ManejoBuses {
    ...
    public static final ManejoBuses objeto = new ManejoBuses(); // Creacion del objeto con Singleton, final porque siempre es el mismo
    ...
    public static ManejoBuses getInstancia(){
        return objeto;
    }
    ...
    public void MayoresVentas() {
        ...
        for (int i = 0; i < matriz.size(); i++) {
            ...
            System.out.println("Mayor cantidad de ventas fue de " + mayorValor + " el dia " + dia + " por el bus numero " + bus);
        }
    }
    ...
    public void MenoresVentas() {
        ...
        for (int i = 0; i < matriz.size(); i++) {
            ...
            System.out.println("Menor cantidad de ventas fue de " + menorValor + " el dia " + dia + " por el bus numero " + bus);
        }
    }
